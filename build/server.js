...
var App = /** @class */ (function () {
    ...
    App.prototype.useErrorHandler = function () {
        this.express.use(middleware_1.errorHandler);
    };
    App.prototype.useNotFoundMiddleware = function () {
        this.express.use(middleware_1.notFoundMiddleware);
    };
    App.prototype.routes = function () {
        (0, api_1.registerRoutesV1)(this.express);
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, mongoose_1.default
                            .connect(process.env.DB_PATH || config_1.default.get("DB_PATH"), {
